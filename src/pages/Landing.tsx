      ...
      <div className="flex flex-col justify-center items-center h-screen z-10-center z-10">
        <div className="animate-[float_2s_ease-in-out_infinite]">
         ...
         <div className='flex flex-col justify-center items-center'>
            <h1 className="text-4xl font-inter text-purple-600 mb-4 justify-center items-center ">Welcome to Hippocampus</h1>
            <h2 className="text-2xl  text-purple-600 mb-4">Capture, organize,and share notes, videos,tweets and links in one beautiful place</h2>
        </div>
